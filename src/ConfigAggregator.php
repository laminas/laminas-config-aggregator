...
EOT;
    ...
    /**
     * @param iterable<ProviderCallable|class-string> $providers Array or \Iterator of providers. These may be
     ...
     * @param list<PostProcessorCallable|class-string> $postProcessors Array of processors. These may be callables, or
     ...
     * Raises an exception for any other condition.
     *
     * @param PostProcessorCallable|class-string $processor
     * @return PostProcessorCallable
     ...
     *
     * @param iterable<ProviderCallable|class-string> $providers
     */
