...
EOT;
    ...
    /**
     * @param iterable<callable|string> $providers Array or \Iterator of providers. These may be
     ...
     * @param null|string $cachedConfigFile Configuration cache file; config is loaded from this file if present, and
     *     written to it if not. null disables caching.
     * @param list<callable|string> $postProcessors Array of processors. These may be callables, or
     *     string values representing classes that act as processors. If the latter, they must be instantiable without
     ...
     *
     * @param iterable<callable|string> $providers
     */
    ...
    /**
     * @param list<callable|string> $processors
     */
